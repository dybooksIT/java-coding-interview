...
public final class DoublyLinkedList {
    ...
    private Node head; // 연결 리스트의 머리 노드
    ...
    public void insertLast(int data) {
        ...
        // currentNode를 머리 노드로 리스트에 연결합니다.
        Node currentNode = head;

        // 리스트에 노드가 없는 상황의 처리입니다.
        if (currentNode == null) {
            head = newNode;
        } else {
            // 마지막 노드로 이동합니다.
            ...
            // newNode를 currentNode.next로 저장합니다.
            currentNode.next = newNode;

            // currentNode를 newNode.prev로 저장합니다.
    ...
    public boolean delete(int data) {
        ...
        while (currentNode != null && currentNode.data != data) {
            // currentNode.next를 currentNode 노드로 저장(다음 노드로 이동)합니다.
            currentNode = currentNode.next;
        }
        ...
        if (currentNode != null) {
            if (currentNode.next != null) {
                ...
                // currentNode.prev.next값으로 null을 저장(이전 노드에서 currentNode의 연결을 해제)합니다.
